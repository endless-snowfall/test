...
public class NoDiagonalSolutionTest extends TestBase {

    private NoDiagonalSolution solution;

    @Before
    public void before() {
        solution = new NoDiagonalSolution();
    }
    ...
    public void test12() {
        ...
        assertEquals(3, solution.countLandMasses(map));
    }
}
